...
exports.sendEmail = exports.login = exports.storeOTPInRedis = exports.verifyOTP = void 0;
...
//<------------------------------- LOGIN WITH MAIL OTP -----------------------------------------
const verifyOTP = async (receivedOTP, email) => {
    console.log(email);
    const expectedOTP = await redis_1.default.get(email);
...
const storeOTPInRedis = async (email, otp) => {
    await redis_1.default.setEx(email, 300, otp); // Expires in 5 minutes (300 seconds)
};
exports.storeOTPInRedis = storeOTPInRedis;
